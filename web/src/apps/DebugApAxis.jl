...
function main()
    ...
    _include_launch()
    # The runtime include defines Launch.datasets / Launch.debug_annotation_ap_axis
    # etc. at a newer world age than this precompiled `main` can see, so run the
    # rest via `invokelatest`.
