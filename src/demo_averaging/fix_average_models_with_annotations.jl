function fix_average_models_with_annotations(
    avg_models,
    ...
    f[5, :] = buttongrid = GridLayout(tellwidth = false)
    buttongrid[1, 1] = Button(f, label = "Previous")
    buttongrid[1, 2] = Button(f, label = "Reset")
    buttongrid[1, 3] = Button(f, label = "Next")
